...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang" ]; then
	...
	CC_SRC_PATH="github.com/hyperledger/fabric-samples/chaincode/score_system/"
...
if [ "${NO_CHAINCODE}" != "true" ]; then
	...
	checkCommitReadiness ${VERSION} 0 1 "\"Org1MSP\": true" "\"Org2MSP\": false"
	checkCommitReadiness ${VERSION} 0 2 "\"Org1MSP\": true" "\"Org2MSP\": false"
